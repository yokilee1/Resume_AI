            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {templates.map((t, idx) => (
                    <motion.div
                        ...
                        className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden group hover:shadow-xl hover:border-slate-300 transition-all"
                    >
                        {/* Fake Preview */}
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className={`flex-1 px-4 py-2.5 text-xs font-black rounded-xl transition-all shadow-lg ${t.status === 'Active' ? 'bg-white border border-red-100 text-red-600 shadow-red-50 hover:bg-red-50' : 'bg-slate-900 text-white shadow-slate-200/50 hover:bg-black'}`}
                                >
                ...
                <motion.button
                    ...
                    className="bg-slate-50/50 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center h-full min-h-[300px] hover:bg-slate-100/50 hover:border-slate-400 transition-all group"
                >
                    <div className="p-4 bg-white rounded-2xl shadow-sm border border-slate-100 group-hover:scale-110 transition-transform text-slate-400 group-hover:text-slate-900">
                        <Plus size={32} />
                    </div>
                    <span className="font-black text-slate-400 group-hover:text-slate-900 uppercase tracking-tighter mt-4 text-xs">设计新模板</span>
                </motion.button>
            </div>
        </div>
    );
